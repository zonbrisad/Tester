   1              		.file	"Fl_get_key.cxx"
   2              		.text
   3              	.Ltext0:
   4              		.section	.text.unlikely._ZN2Fl9event_keyEi.part.0,"ax",@progbits
   5              		.align 2
   6              	.LCOLDB0:
   7              		.section	.text._ZN2Fl9event_keyEi.part.0,"ax",@progbits
   8              	.LHOTB0:
   9              		.align 2
  10              		.p2align 4,,15
  11              		.section	.text.unlikely._ZN2Fl9event_keyEi.part.0
  12              	.Ltext_cold0:
  13              		.section	.text._ZN2Fl9event_keyEi.part.0
  15              	_ZN2Fl9event_keyEi.part.0:
  16              	.LFB309:
  17              		.file 1 "fltk-1.3.4-1/src/Fl_get_key.cxx"
   1:fltk-1.3.4-1/src/Fl_get_key.cxx **** ...
  18              		.loc 1 34 0
  19              		.cfi_startproc
  20              	.LVL0:
  21 0000 4883EC08 		subq	$8, %rsp
  22              		.cfi_def_cfa_offset 16
  23              		.loc 1 45 0
  24 0004 4863F7   		movslq	%edi, %rsi
  25 0007 488B3D00 		movq	fl_display(%rip), %rdi
  25      000000
  26              	.LVL1:
  27 000e E8000000 		call	XKeysymToKeycode
  27      00
  28              	.LVL2:
  29 0013 0FB6F0   		movzbl	%al, %esi
  30              	.LVL3:
  31 0016 31D2     		xorl	%edx, %edx
  32              		.loc 1 46 0
  33 0018 85F6     		testl	%esi, %esi
  34 001a 741B     		je	.L2
  35              		.loc 1 47 0
  36 001c C1FE03   		sarl	$3, %esi
  37              	.LVL4:
  38 001f 83E007   		andl	$7, %eax
  39              	.LVL5:
  40 0022 4863F6   		movslq	%esi, %rsi
  41 0025 89C1     		movl	%eax, %ecx
  42 0027 0FBE9600 		movsbl	fl_key_vector(%rsi), %edx
  42      000000
  43 002e BE010000 		movl	$1, %esi
  43      00
  44 0033 D3E6     		sall	%cl, %esi
  45 0035 21F2     		andl	%esi, %edx
  46              	.L2:
  47              		.loc 1 48 0
  48 0037 89D0     		movl	%edx, %eax
  49 0039 4883C408 		addq	$8, %rsp
  50              		.cfi_def_cfa_offset 8
  51 003d C3       		ret
  52              		.cfi_endproc
  53              	.LFE309:
  55              		.section	.text.unlikely._ZN2Fl9event_keyEi.part.0
  56              	.LCOLDE0:
  57              		.section	.text._ZN2Fl9event_keyEi.part.0
  58              	.LHOTE0:
  59              		.section	.text.unlikely._ZN2Fl9event_keyEi,"ax",@progbits
  60              		.align 2
  61              	.LCOLDB1:
  62              		.section	.text._ZN2Fl9event_keyEi,"ax",@progbits
  63              	.LHOTB1:
  64              		.align 2
  65              		.p2align 4,,15
  66              		.globl	_ZN2Fl9event_keyEi
  68              	_ZN2Fl9event_keyEi:
  69              	.LFB307:
  70              		.loc 1 34 0
  71              		.cfi_startproc
  72              	.LVL6:
  73              		.loc 1 35 0
  74 0000 8D871701 		leal	-65257(%rdi), %eax
  74      FFFF
  75 0006 83F807   		cmpl	$7, %eax
  76 0009 7715     		ja	.L13
  77              	.LVL7:
  78              	.LBB10:
  79              	.LBB11:
  80              		.file 2 "fltk-1.3.4-1/FL/Fl.H"
 ...
 709:fltk-1.3.4-1/FL/Fl.H ****   static int event_state(int mask) {return e_state&mask;}
  81              		.loc 2 709 0
  82 000b 8D8F1801 		leal	-65256(%rdi), %ecx
  82      FFFF
  83 0011 B8080000 		movl	$8, %eax
  83      00
  84 0016 D3E0     		sall	%cl, %eax
  85 0018 23050000 		andl	_ZN2Fl7e_stateE(%rip), %eax
  85      0000
  86              	.LVL8:
  87              	.LBE11:
  88              	.LBE10:
  89              		.loc 1 48 0
  90 001e C3       		ret
  91 001f 90       		.p2align 4,,10
  92              		.p2align 3
  93              	.L13:
  94 0020 E9000000 		jmp	_ZN2Fl9event_keyEi.part.0
  94      00
  95              	.LVL9:
  96              		.cfi_endproc
  97              	.LFE307:
  99              		.section	.text.unlikely._ZN2Fl9event_keyEi
 100              	.LCOLDE1:
 101              		.section	.text._ZN2Fl9event_keyEi
 102              	.LHOTE1:
 103              		.section	.text.unlikely._ZN2Fl7get_keyEi,"ax",@progbits
 104              		.align 2
 105              	.LCOLDB2:
 106              		.section	.text._ZN2Fl7get_keyEi,"ax",@progbits
 107              	.LHOTB2:
 108              		.align 2
 109              		.p2align 4,,15
 110              		.globl	_ZN2Fl7get_keyEi
 112              	_ZN2Fl7get_keyEi:
 113              	.LFB308:
 114              		.loc 1 50 0
 115              		.cfi_startproc
 116              	.LVL10:
 ...
 119              		.cfi_offset 3, -16
 120              		.loc 1 50 0
 121 0001 89FB     		movl	%edi, %ebx
 122              		.loc 1 51 0
 123 0003 E8000000 		call	_Z15fl_open_displayv
 123      00
 124              	.LVL11:
 125              		.loc 1 52 0
 126 0008 488B3D00 		movq	fl_display(%rip), %rdi
 126      000000
 127 000f BE000000 		movl	$fl_key_vector, %esi
 127      00
 128 0014 E8000000 		call	XQueryKeymap
 128      00
 129              	.LVL12:
 130              	.LBB12:
 131              	.LBB13:
 132              		.loc 1 35 0
 133 0019 8D831701 		leal	-65257(%rbx), %eax
 133      FFFF
 134 001f 83F807   		cmpl	$7, %eax
 135 0022 771C     		ja	.L20
 136              	.LVL13:
 137              	.LBB14:
 138              	.LBB15:
 139              		.loc 2 709 0
 140 0024 8D8B1801 		leal	-65256(%rbx), %ecx
 140      FFFF
 141 002a B8080000 		movl	$8, %eax
 141      00
 142              	.LBE15:
 143              	.LBE14:
 144              	.LBE13:
 ...
 154              	.LBB16:
 155              		.loc 2 709 0
 156 0030 D3E0     		sall	%cl, %eax
 157 0032 23050000 		andl	_ZN2Fl7e_stateE(%rip), %eax
 157      0000
 158              	.LVL15:
 159              	.LBE16:
 160              	.LBE17:
 ...
 164 0038 C3       		ret
 165              	.LVL16:
 166 0039 0F1F8000 		.p2align 4,,10
 166      000000
 167              		.p2align 3
 168              	.L20:
 ...
 170              	.LBB22:
 171              	.LBB19:
 172 0040 89DF     		movl	%ebx, %edi
 173              	.LBE19:
 174              	.LBE22:
 175 0042 5B       		popq	%rbx
 176              		.cfi_def_cfa_offset 8
 177              	.LVL17:
 178              	.LBB23:
 179              	.LBB20:
 180 0043 E9000000 		jmp	_ZN2Fl9event_keyEi.part.0
 180      00
 181              	.LVL18:
 182              	.LBE20:
 183              	.LBE23:
 184              		.cfi_endproc
 185              	.LFE308:
 187              		.section	.text.unlikely._ZN2Fl7get_keyEi
 188              	.LCOLDE2:
 189              		.section	.text._ZN2Fl7get_keyEi
 190              	.LHOTE2:
 191              		.text
 192              	.Letext0:
 193              		.section	.text.unlikely._ZN2Fl9event_keyEi.part.0
 194              	.Letext_cold0:
 195              		.file 3 "fltk-1.3.4-1/FL/fl_types.h"
 196              		.file 4 "/usr/lib/gcc/x86_64-linux-gnu/5/include/stddef.h"
 197              		.file 5 "/usr/include/x86_64-linux-gnu/bits/types.h"
 198              		.file 6 "/usr/include/libio.h"
 199              		.file 7 "fltk-1.3.4-1/FL/Enumerations.H"
 200              		.file 8 "fltk-1.3.4-1/FL/Fl_Widget.H"
 201              		.file 9 "fltk-1.3.4-1/FL/Fl_Image.H"
 202              		.file 10 "/usr/include/X11/Xlib.h"
 203              		.file 11 "/usr/include/stdio.h"
 204              		.file 12 "fltk-1.3.4-1/FL/x.H"
DEFINED SYMBOLS
                            *ABS*:0000000000000000 Fl_get_key.cxx
     /tmp/ccnDb3Bj.s:15     .text._ZN2Fl9event_keyEi.part.0:0000000000000000 _ZN2Fl9event_keyEi.part.0
     /tmp/ccnDb3Bj.s:68     .text._ZN2Fl9event_keyEi:0000000000000000 _ZN2Fl9event_keyEi
     /tmp/ccnDb3Bj.s:112    .text._ZN2Fl7get_keyEi:0000000000000000 _ZN2Fl7get_keyEi
