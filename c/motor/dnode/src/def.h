...
#define E_CUR_RETURN  "\e[1F"      // cursor return
#define E_CUR_UP      "\e[1A"      // cursor n up
//#define E_CUR_UP      "\e[;A"      // cursor up
#define E_CUR_DOWN    "\e[1B"      // cursor n down
#define E_CUR_FORWARD "\e[1C"      // cursor n forward
#define E_CUR_BACK    "\e[D"      // cursor n backward
#define E_CUR_NEXT    "\e[W"       // move cursor to next line

#define E_HIDE_CURSOR "\e[?25l"     // hide cursor
#define E_SHOW_CURSOR "\e[?25h"     // show cursor
